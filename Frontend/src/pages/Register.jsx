    ...
    <div className=" flex items-center justify-center mt-[5%] ">
      <div className=" flex items-center bg-white shadow-lg rounded-lg overflow-hidden ">
        ...
        <div className="p-10 w-[500px] ">
          ...
          <form action="" className="spay-y-5">
            <div className="mb-5">
            ...
            <button className="w-full py-2 bg-[#d55fbb] text-white font-bold rounded-md transition-tranform duration-500 hover:bg-blue-200 focus:outline-none focus:ring-red-500 transform hover:scale-105 ">
              Create an account
            </button>
